# 콩떡몰
<p align="center"><a href="http://beanricecakemall.store/"><img src="https://github.com/user-attachments/assets/67382621-7fad-4f86-af80-716ca6dbcc31" width="300" height="200"></a></p>
...
## 프로젝트 소개/목표
반려동물에 대한 가족 같은 문화가 확산됨에 따라 반려견 '콩떡'이를 모델로 한 신뢰할 수 있는 반려견 쇼핑몰을 운영하며, 반려동물과 반려인을 위해 고품질 제품과 서비스를 제공하여 삶의 질을 높이고자 합니다.


## 프로젝트 선정이유
전 프로젝트 “화개장터”에서 관리자 페이지를 주로 구현해 대표 기능(상품 판매/구매 로직, 로그인 등)을 직접 다루지 못한 아쉬움이 남아, 처음부터 끝까지 모든 기능을 구현해 보고자 주제를 선정했습니다.
